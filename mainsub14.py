...
#
old_ranking = utils.load_csv("ranking_inicial_sub14_dos_orillas.csv")
players_list = utils.load_csv("jugadores_sub14_dos_orillas.csv")
...
matches_filename1 = "partidos_sub14_torneo1_dosorillas2016.csv"
...
# Saving new ranking
utils.save_csv("ranking_sub14_torneo1_dos_orillas.csv",
...
old_ranking = utils.load_csv("ranking_sub14_torneo1_dos_orillas.csv")
players_list = utils.load_csv("jugadores_sub14_dos_orillas.csv")
...
matches_filename2 = "partidos_sub14_torneo2_dosorillas2016.csv"
...
# Saving new ranking
utils.save_csv("ranking_sub14_torneo2_dos_orillas.csv",
               ["player_id", "rating", "name"],
               new_ranking)
