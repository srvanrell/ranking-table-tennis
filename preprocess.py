...
players.load_list(utils.load_csv(folder + players_info_filename))

# Loading initial ranking and adding new players with 0
raw_ranking = utils.load_csv(folder + ranking_filename)
...
for tournament_filename in tournament_filenames:
    ...
    tournament = utils.load_tournament_csv(folder + tournament_filename)
...
utils.save_csv(folder + players_info_filename,
...
utils.save_csv(folder + ranking_filename,
